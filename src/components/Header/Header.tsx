        ...
        <section className="header__left-mobile">
          ...
          >
            <div className="header__link-wrap">
              {isOpen ? (
                <img className="header__link-img" src={Cross} alt="burger" />
              ) : (
          ...
          {/* 
          <Link to="menu" className="header__link-cross">
            <div className="header__link-wrap">
              <a href="*">
              <img className="header__link-img" src={Burger} alt="burger" />
              </a>
        ...
        <section className="header__right">
          <NavLink to="/favorites" className="header__link">
            <div className="header__link-wrap">
              ...
              {favoritesLength > 0 && (
                <div className="header__link-img-count">{favoritesLength}</div>
              )}
            </div>
          </NavLink>
          ...
          <NavLink to="/cart" className="header__link">
            <div className="header__link-wrap">
              ...
              {itemsInCart > 0 && (
                <div className="header__link-img-count">{itemsInCart}</div>
              )}
            </div>
          </NavLink>
        </section>
        ...
        <aside className="menu" id="menu">
          ...
          <nav className="menu__nav">
            <ul className="menu__nav-list">
              ...
              <li className="menu__nav-item">
                <NavLink to="/phones" className="menu__nav-link">
                  phones
                </NavLink>
              </li>

              <li className="menu__nav-item">
                <NavLink to="/tablets" className="menu__nav-link">
                  tablets
                </NavLink>
              </li>

              <li className="menu__nav-item">
                <NavLink to="/accessory" className="menu__nav-link">
                  accessory
                </NavLink>
              </li>
            </ul>
          ...
          <section className="menu__bottom">
            <NavLink to="/favorites" className="menu__link">
              <div className="menu__link-wrap">
                ...
                {favoritesLength > 0 && (
                  <div className="menu__link-img-count">{favoritesLength}</div>
                )}
              </div>
            </NavLink>

            <NavLink to="/cart" className="menu__link">
              <div className="menu__link-wrap">
                <img src={Cart} className="menu__link-img" alt="link-img" />
                {itemsInCart > 0 && (
                  <div className="menu__link-img-count">{itemsInCart}</div>
                )}
              </div>
            </NavLink>
          </section>
